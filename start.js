...
var constants = require('lcp_lib/constants.js');
var desktopApp = require('lcp_lib/desktop_app.js');
...
var conf = require('lcp_lib/conf.js');
var objectHash = require('lcp_lib/object_hash.js');
var db = require('lcp_lib/db.js');
var eventBus = require('lcp_lib/event_bus.js');
var ecdsaSig = require('lcp_lib/signature.js');
var storage = require('lcp_lib/storage.js');
...
function createWallet(xPrivKey, onDone){
	...
	var device = require('lcp_lib/device.js');
	...
	var walletDefinedByKeys = require('lcp_lib/wallet_defined_by_keys.js');
	...
	readKeys(function(mnemonic_phrase, passphrase, deviceTempPrivKey, devicePrevTempPrivKey){
		...
		readSingleWallet(function(wallet){
			...
			db.query("SELECT 1 FROM extended_pubkeys WHERE device_address=?", [my_device_address], function(rows){
				...
				if (conf.bLight){
					var light_wallet = require('lcp_lib/light_wallet.js');
