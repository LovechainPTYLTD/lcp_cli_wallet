...
const desktopApp = require('lcp_lib/desktop_app.js');
const conf = require('lcp_lib/conf.js');
const Mnemonic = require('bitcore-mnemonic');
const crypto = require('crypto');
const objectHash = require('lcp_lib/object_hash.js');
const wallet_defined_by_keys = require('lcp_lib/wallet_defined_by_keys.js');
const Bitcore = require('bitcore-lib');
const network = require('lcp_lib/network');
const myWitnesses = require('lcp_lib/my_witnesses');
const db = require('lcp_lib/db.js');
...
setTimeout(() => {
	getKeys(async (mnemonic_phrase, passphrase, deviceTempPrivKey, devicePrevTempPrivKey) => {
		...
		const device = require('lcp_lib/device.js');
		require('lcp_lib/wallet.js'); // we don't need any of its functions but it listens for hub/* messages
		...
		if (conf.bLight) {
			const light_wallet = require('lcp_lib/light_wallet.js');
